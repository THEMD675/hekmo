    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <header className="container mx-auto px-6 py-20 text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto">
          ...
          <br />
          <span className="text-emerald-400">24/7 WhatsApp support in Arabic.</span>
        </p>
      ...
      <section className="container mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <PricingCard
            name="Business"
            price="1,499"
            features={["10,000 رسالة/شهر", "3 أرقام واتساب", "دعم أولوية", "لوحة تحكم متقدمة"]}
            featured
          />
          <PricingCard
            name="Enterprise"
            price="Custom"
            features={["رسائل غير محدودة", "أرقام غير محدودة", "مدير حساب مخصص", "API كامل"]}
          />
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-400 mb-8">تجربة مجانية 14 يوم. بدون بطاقة ائتمان.</p>
        <Link
          href="/register"
  ...
  return (
    <div
      className={`p-6 rounded-xl border ${
        featured ? "border-emerald-500 bg-emerald-500/10" : "border-gray-700 bg-gray-800/50"
      }`}
    >
