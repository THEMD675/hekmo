  ...
  return (
    <div className="container max-w-4xl py-12 px-4" dir="rtl">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2>رؤيتنا</h2>
        <p>
          نؤمن بأن كل شخص يستحق الوصول لذكاء اصطناعي متقدم بلغته الأم. لذلك
          أنشأنا حكمو ليكون مساعدك الذكي الذي يفهم احتياجاتك ويتحدث لغتك.
        </p>
          ...
          <div className="flex gap-4 p-4 rounded-lg border">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                نضع احتياجات المستخدم في قلب كل ما نفعله
              </p>
            </div>
          </div>
          <div className="flex gap-4 p-4 rounded-lg border">
