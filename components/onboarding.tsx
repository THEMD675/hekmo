...
const STEPS: OnboardingStep[] = [
  {
    ...
    description:
      "مساعدك الذكي للصحة باللغة العربية. اسألني أي سؤال وسأساعدك بأفضل المعلومات الصحية.",
  },
  {
  ...
  },
  {
    ...
    title: "أدوات ذكية",
    description:
      "أستطيع حساب مؤشر كتلة الجسم، البحث في الإنترنت، قراءة ملفات PDF، والمزيد من الأدوات المفيدة.",
  },
  {
    icon: <Shield className="h-12 w-12" />,
    title: "خصوصية تامة",
    description:
      "بياناتك آمنة ومحمية. لا نشارك معلوماتك الصحية مع أي طرف ثالث.",
  },
];
